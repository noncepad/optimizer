...
// Exported so other packages building on this one share the same default
...
// endpoint every other read in this codebase uses, given a raw
// -state-url flag value. Exported so other standalone entrypoints
// building on this package can dial the same way without duplicating
// this parsing.
